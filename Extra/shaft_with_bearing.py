...
def run(D, t, L, tilt, F_hub, M_hub, npts):
    ...
    # imb2   = inode[n-5] # Adjust index of where main bearing is located
    ...
    #F_mb2   = -1.0 * np.array([reactions2.Fx[iCase,0], reactions2.Fy[iCase,0], reactions2.Fz[iCase,0]])
    ...
    # print('Forces on main bearing:',F_mb2.tolist())
