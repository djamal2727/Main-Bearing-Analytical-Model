...
if __name__ == '__main__':
    ...
    while i<3000:
        ...
        f_r1v.append(radial1)
        f_r2v.append((F_mb2[1]**2 + F_mb2[2]**2)**0.5)
        f_a1v.append(-F_mb1[0])
        f_total1v.append(1.2*radial1 + 0.39*F_mb1[0])
        i=i+1
      

f_r1, f_r2, f_a1, f_total1 = MainBearingCalc.MB_forces(rho,torque, RotThrust, m_y,m_z, f_y, rot_speed)
